    ...
    <div className=" bg-black border-[1px] border-[#25262B] min-h-screen w-screen max-w-full">
      ...
      <div className="h-[80vh] text-white  max-h-[90vh] w-screen max-w-full flex items-center justify-center">
        <div className="bg-[#111214] aspect-video w-[38%] rounded-xl p-5 flex flex-col items-center justify-center gap-6">
          ...
          <button className=" rounded-md bg-gradient-to-r from-[#4B63DD] to-[#0524BF] font-OpenSans-SemiBold px-6 p-3">Create an Account</button>
          <h1 className=" font-OpenSans-Regular text-[#909296]">Already have an account? <Link to="/sign-in"><span className="text-white hover:underline cursor-pointer">Sign In</span></Link> </h1>
        </div>
      </div>
    </div>
  );
